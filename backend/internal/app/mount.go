...
func (e *Engine) handlers() server.Handlers {
	...
	out["admin.index.estimate"] = e.searchHTTP.IndexEstimate
	out["admin.index.status"] = e.searchHTTP.IndexStatus
	out["admin.index.build"] = e.searchHTTP.IndexBuild
	out["search.stream"] = e.searchHTTP.SearchStream
