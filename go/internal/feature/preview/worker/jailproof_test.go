...
import (
	...
	"github.com/heavycaffeiner/stowcloud/go/internal/feature/preview/worker"
...
func buildJailedWorker(t *testing.T) string {
	...
	jailedOnce.Do(func() {
		...
		cmd := exec.Command("go", "build", "-o", bin,
			"github.com/heavycaffeiner/stowcloud/go/internal/feature/preview/worker/jailedworker")
