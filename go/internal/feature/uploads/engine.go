...
type Engine struct {
	...
	// lifecycleMu serializes shutdown against writer admission.
...
// Close stops every merger and releases upload-owned resources. A caller that
// does not call it leaks a goroutine per cached session.
