...
func (s *Server) searchProviders(c *gin.Context, p Principal) (Val, bool, *Error) {
	items := []Val{
...
func (s *Server) searchQuery(c *gin.Context, p Principal, provider string) (Val, bool, *Error) {
	switch provider {
	case "files":
...
func (s *Server) searchFilesByName(c *gin.Context, p Principal) (Val, bool, *Error) {
	const name = "Files"
...
func (s *Server) searchFavoriteEntries(c *gin.Context, p Principal) (Val, bool, *Error) {
...
// store's starred set.
func (s *Server) favoriteFiles(c *gin.Context, p Principal) (Val, bool, *Error) {
	ctx := c.Request.Context()
	set, err := s.deps.Store.Favorites(ctx, user(p))
	if err != nil {
		return Val{}, false, ocsErrorOf(err, apierr.VisibilityHidden)
