...
func (s *Server) currentUser(c *gin.Context, p Principal) (Val, bool, *Error) {
...
func (s *Server) otherUser(c *gin.Context, p Principal, login string) (Val, bool, *Error) {
	ctx := c.Request.Context()
...
// sentinel is for.
func (s *Server) accountValOf(c *gin.Context, id int64, info auth.AccountInfo) Val {
	ctx := c.Request.Context()
...
// one that made it.
func (s *Server) appPassword(c *gin.Context, p Principal) (Val, bool, *Error) {
...
func (s *Server) revokeAppPassword(c *gin.Context, p Principal) (Val, bool, *Error) {
