...
// SealDescriptors closes everything above fd 3.
//
...
// obtain and does nothing about the ones it inherited.
func SealDescriptors() error {
	...
	// does not hold is the expected and harmless result.
	for fd := 4; fd < fdSweepMax; fd++ {
