...
func metadata(cfg Config) Metadata {
	...
	return Metadata{Toolchain: runtime.Compiler, GoVersion: runtime.Version(), GOOS: runtime.GOOS, GOARCH: runtime.GOARCH, CPUs: runtime.NumCPU(), GOMAXPROCS: runtime.GOMAXPROCS(0), Source: "github.com/heavycaffeiner/stowcloud/go/tools/namesearchbench", Hardware: hardware, Filesystem: cfg.Filesystem, Cache: cfg.Cache, Concurrency: cfg.Concurrency}
}
