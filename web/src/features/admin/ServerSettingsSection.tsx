...
export function ServerSettingsSection() {
  ...
  function card(id: string, title: string, subtitle: string, children: ReactNode) { return <AdminCard id={id} title={title} subtitle={subtitle} icon={<Icon name="settings" />} headingLevel="h4" bodyClassName="sc-server-settings__form">{children}</AdminCard> }
